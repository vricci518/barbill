    ...
    <div class="mainfaq">
        ...
        <div class="FAQ">
            ...
            <ul>
                <li>Personal Protective Equipment
                    ...
                    -All guests must wear a mask unless seated at the table</li>
                <li>Social Distancing
                    -Operating at half capacity with extra space between tables
                    -Booking by reservation only to enforce limited diners
                    -Distancing maintained in common areas
                    -Diners wait in their cars until their tables are ready </li>
                <li>Cleaning & Sanitizing
                    -Surfaces sanitized after every meal
                    -QR codes provided at tables to minimize paper menus
        ...
        <div class="FAQ">
            ...
            <ul>
                ...
                <li>If you have any further gift card issues please send us a message through our 'contact us' form or send us a private message on facebook or instagram and someone will get back to you shortly!</li></br>
                <a href="https://www.toasttab.com/bar-bill/findcard" class="button" target="_blank">www.toasttab.com/bar-bill/findcard</a> </br>
            </ul>
        </div>
        <div class="FAQimg">
