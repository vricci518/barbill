...
<div>
    ...
    <ul>
        ...
        <li>East Aurora curbside takeout is open Monday - Sunday from 11:30 am til 9:00 pm</li>
        <li>Clarence dine-in is open Monday - Saturday from 11:30 am til 10:00 pm (last seatings at 8:30 pm) & sundays from 11:30 am til 8:00 pm</li>
    ...
    <ul>
        ...
        </br>-all staff must wear a mask
        </br>-all guests must wear a mask unless seated at the table</li>
        <li>Social Distancing
        </br>-operating at half capacity with extra space between tables
        </br>-booking by reservation only to enforce limited diners
        </br>-distancing maintained in common areas
        </br>-diners wait in their cars until their tables are ready </li>
        <li>Cleaning & Sanitizing
        </br>-surfaces sanitized after every meal
        </br>-QR codes provided at tables to minimize paper menus
        </br>-common areas deep cleaned daily</li>
    </ul>
    <div class="FAQimg">
    ...
    <ul>
        <li>For East Aurora: place your order online through our website or by calling (716) 652-7959</br>For Clarence: place your order online through our website (*no phone orders at this location*)</li>
        <li>For online orders it is important to check the 'estimated ready time' at the top of the order page prior to hitting submit.</li>
        <li>Our system cannot accept preorders for a later time, only those placed in real time. We also cannot take preorders over the phone.</li>
        <li>Please note that weekends are usually busy often with longer wait times.</li>
        <li>A cell phone number will be needed at checkout so that we can text you when your order is ready. Please do not input a landline number with your order.</li>
    </ul>
    <div class="FAQimg">
    ...
    <div class="FAQimg">
        <img src="https://popmenucloud.com/cdn-cgi/image/width=768,height=768,fit=scale-down,format=auto,quality=60/laworbdj/15a1bbc4-9090-4bd6-8e4a-c463f94635f8.png"/>
    </div>
    </br>
    ...
    <ul>
        ...
        <li>If you have any further gift card issues please send us a message through our 'contact us' form or send us a private message on facebook or instagram and someone will get back to you shortly!</li>
    </ul>
    <a href="https://www.toasttab.com/bar-bill/findcard" class="button" target="_blank" padding="20px 40px" margin="20px 20px">www.toasttab.com/bar-bill/findcard</a> </br>
    <div class="FAQimg">
        <img src="https://popmenucloud.com/cdn-cgi/image/width=768,height=768,fit=scale-down,format=auto,quality=60/laworbdj/da7a6576-6d1f-4f7e-ae5e-b9d10ac413ef.JPG"/>
    </div>
</br>    
    ...
    <div class="FAQimg">
        <img src="https://popmenucloud.com/cdn-cgi/image/width=768,height=768,fit=scale-down,format=auto,quality=60/laworbdj/9db7e650-54d6-44a5-b3f6-070ccfb92adf.jpeg"/>
    </div>
    </br>
